  ...
  <section className='max-padd-container bg-hero bg-cover bg-center bg-no-repeat h-[744px] w-full' id='home'>
    <div >
        <div className='relative top-24 xs:top-72'>
            ...
            <h1 className='h1 capitalize max-w-[40 rem]'>
                Upgrade Your Fashion <span className=' text-secondary'>with Every Click.</span> Shop Today!
            </h1>
            <p className='my-5 max-w-[33rem]'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Et cupiditate facilis at totam odit! Tenetur iusto, .</p>
        <div className='flex items-center gap-x-4'>
            <Link to={'/'} className='inline-flex items-center justify-center gap-4 p-3 bg-white rounded-xl'>
            <div className='regular-1 leading-tight pl-4'>
            ...
            <Link  to={'/'} className='inline-flex items-center justify-center gap-4 p-3 bg-black text-white rounded-xl'>
            <div className='regular-1 leading-tight pl-4'>
